...
import com.example.cuahang_client.Adapter.SanphamAdapter;
import com.example.cuahang_client.Model.Sanpham;
...
public class AllPC extends AppCompatActivity {
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_all_daudocmavach);
        intit();
        GetInfor();
        ActionTool();
    }
    ...
    private void GetInfor() {
        JsonArrayRequest jsonArrayRequest1 = new JsonArrayRequest(Server.GetPC, new Response.Listener<JSONArray>() {
            @Override
    ...
    public void intit(){
        toolbar = (Toolbar) findViewById(R.id.toolPC);
        recyclerView = (RecyclerView) findViewById(R.id.recyclerPC);
        list = new ArrayList<>();
