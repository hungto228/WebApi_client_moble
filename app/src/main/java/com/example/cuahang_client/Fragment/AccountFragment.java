...
import com.example.cuahang_client.Admin.Donhang;
import com.example.cuahang_client.Admin.Thongke;
import com.example.cuahang_client.Login.FragmentDangNhap;
import com.example.cuahang_client.Login.Login;
import com.example.cuahang_client.QuanLySanPham;
import com.example.cuahang_client.R;
import com.example.cuahang_client.Search.TaiKhoan;
        ...
        logout1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!fragmentDangNhap.LayCached(getContext()).equals("")) {
                    fragmentDangNhap.updateCaced(getContext(), "","",0,0,"","");
...
//                    fragmentDangNhap.updateCaced2(getContext(),"","","");
    ...
    public void checkdata() {
        ...
        int  maloaitk = Integer.parseInt(String.valueOf(sharedPreferences.getInt("maloaitk",0)));
