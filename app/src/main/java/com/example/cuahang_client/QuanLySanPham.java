...
package com.example.cuahang_client;
...
import com.example.cuahang_client.Adapter.QuanLySPAdapter;
import com.example.cuahang_client.Admin.Themsanpham;
...
public class QuanLySanPham extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSearch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                list.clear();
               String tukhoa = editText.getText().toString().toLowerCase().trim();
                if (!tukhoa.isEmpty()) {
                    Search();
                } else {
    ...
    public void Search(){
        ...
        String url = "http://10.40.1.29:45455/CuaHang/getSP_ten/";
