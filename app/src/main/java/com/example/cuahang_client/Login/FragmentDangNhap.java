package com.example.cuahang_client.Login;
...
import com.example.cuahang_client.Fragment.AccountFragment;
...
public class FragmentDangNhap extends Fragment {
    ...
    public void Login() {
        ...
        StringRequest MyStringRequest = new StringRequest(Request.Method.GET, Server.GetLogin + taikhoan + "/" + matkhau, new Response.Listener<String>() {
            @Override
                ...
                try {
                    ...
                    for (int i = 0; i < jsonArray.length(); i++) {
                        ...
                        if (checkBox.isChecked()) {
                            updateCaced(getContext(), tendangnhap, diachi,id,maloai,hoten,sdt);
...
//                            updateCaced2(getContext(), hoten, diachi, sdt);
            ...
            protected Map<String, String> getParams() {
                ...
                MyData.put("tendangnhap", taikhoan);
    ...
    public void updateCaced(Context context, String tendangnhap, String diachi, int matv, int maloaitk, String hoten, String sdt) {
