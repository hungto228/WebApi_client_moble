...
import com.example.cuahang_client.Chitietsanpham;
import com.example.cuahang_client.Fragment.Updatesanpham;
import com.example.cuahang_client.Model.CheckConnection;
...
public class QuanLySPAdapter extends RecyclerView.Adapter<QuanLySPAdapter.ItemHoler> {
    ...
    public void Delete(int id, final int position){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.DELETE, Server.linkDeleteSp,
